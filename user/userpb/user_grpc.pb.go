...
func (c *userServiceClient) CreateUpdateUser(ctx context.Context, in *CreateUpdateUserRequest, opts ...grpc.CallOption) (*CreateUpdateUserResponse, error) {
	out := new(CreateUpdateUserResponse)
	err := c.cc.Invoke(ctx, "/userpb.UserService/CreateUpdateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) CreateUpdateUser(context.Context, *CreateUpdateUserRequest) (*CreateUpdateUserResponse, error) {
...
func _UserService_CreateUpdateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateUpdateUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).CreateUpdateUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/userpb.UserService/CreateUpdateUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).CreateUpdateUser(ctx, req.(*CreateUpdateUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
